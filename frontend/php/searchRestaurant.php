            ...
            <div class = "col-sm-12" id = "main-holder">
                    ...
                    <div class = "row">
                        <div class = "col-sm-12" id = "divToHoldRest">
                            ...
                            <div class = "row" id = "main_row_id">
                                
                                <!-- Card One -->
                                <div class = "col-lg-4" id = "card_holder_id"> 
                                    <div class = "custom-card" id = "card_id">
                                        
                                        <!-- Image, Name, Address -->
                                        <div class = "row" id = "row_one_in_card">
                                            <div class = "col-3 col-lg-3" id = "thumb_holder">
                                                <img src = "../asset/food-image.png" id = "thumb_id">
                                            </div>
                                            
                                            <div class = "col-9 col-lg-9" id = "name_address_holder">
                                                <div class = "row">
                                                    <div class = "col-lg-12" id = "rest_name_id">   
                                                        Delicious Indian cuisine
                                                    </div>
                                                    <div class = "col-lg-12" id = "rest_address_id"> 
                                                        1100 Parsippany blvd, Parsippany, NJ 07054
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        
                                        <!-- Rating, Menu, suggestion and Review -->
                                        <div class = "row" id = "row_two_in_card">
                                            <div class = "col-12 col-lg-3" id = "rating_and_text_holder">
                                                <div class = "row" id = "rating_text_holder_row">
                                                    <div class = "col-6 col-lg-12" id = "rating_holder"> 
                                                        <div id = "rating_id">
                                                            Rating: 4.7
                                                        </div>
                                                    </div>
                                                    <div class = "col-6 col-lg-12" id = "rating_text_holder">   
                                                        <div id = "rating_text_id">
                                                            Good
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class = "col-12 col-lg-9" id = "all_buttons_holder">
                                                <div id = "three_buttons">
                                                    <div class="btn-group" role="group" aria-label="Basic example" id = "three_buttons_holder">
                                                        <button type="button" class="btn btn-secondary" id = "menu_button_id">Menu</button>
                                                        <button type="button" class="btn btn-secondary" id = "suggestion_button_id">Suggestion</button>
                                                        <button type="button" class="btn btn-secondary" id = "review_button_id">Review</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class = "col-12 col-lg-9">
                                                <div id = "three_buttons">
                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                        ...
                                                        <button type="button" class="btn btn-secondary">Suggestion</button>
