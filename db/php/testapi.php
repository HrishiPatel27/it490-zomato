<?php 
    ...
    $query = "SELECT menu_url FROM restaurant WHERE restaurant_id = '16794929'";
    $result = $connection->query($query);
    while ($row = $result->fetch_assoc()){
        $menu_url = $row['menu_url'];
    }
    echo $menu_url . "<br>";
    $url = getMenu("https://www.zomato.com/parsippany-nj/chand-palace-parsippany/menu?utm_source=api_basic_user&utm_medium=api&utm_campaign=v2.1&openSwipeBox=menu&showMinimal=1#tabtop");
https://www.zomato.com/parsippany-nj/chand-palace-parsippany?utm_source=api_basic_user&utm_medium=api&utm_campaign=v2.1
    $url = getMenu($menu_url);
//
//    echo var_dump($list);
